...
#--------------------------------------------
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002043502363 -1002245813234 -1002259075109').split()] 
...
├⍟ ᴍʏ ɴᴀᴍᴇ : <a href='https://t.me/PrimeStoreXBot'>PʀɪᴍᴇSᴛᴏʀᴇXʙᴏᴛ</a>
