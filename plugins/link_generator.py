...
async def batch(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("a🔁 Share URL", url=f'https://telegram.me/share/url?url={link}')]])
...
async def link_generator(client: Client, message: Message):
    ...
    link = f"https://t.me/{client.username}?start={base64_string}"
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("b🔁 Share URL", url=f'https://telegram.me/share/url?url={link}')]])
...
async def custom_batch(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("c🔁 Share URL", url=f'https://telegram.me/share/url?url={link}')]])
